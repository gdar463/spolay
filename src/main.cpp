...
int main() {
	...
	while (!state.done) {
		...
		// vkAcquireNextImageKHR can report OUT_OF_DATE without returning an image.
		// Recreate next iteration; do not submit a command buffer waiting on its semaphore.
